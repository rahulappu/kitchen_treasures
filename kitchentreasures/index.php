...
<br>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center marb-35">
                    <h1 class="header-h">Kudumbasree Organization and Keraala Government</h1>
                    <p class="header-p">You can order yummy and delicious home made food ,which are cooked by each staff in "kudumbasree" at your place
                    <br>Each staff is assigned to upload there prepared dish,"kudumbasree" aims woman empowerment through this site </p>
                </div>
                <div class="col-md-1"></div>
                <div class="col-md-10">
                    <div class="col-md-6 col-sm-6">
                        <div class="about-info">
                            <h2 class="heading">Facilities Of This Site</h2>
                            <p>If we want a particular food item,you can suggest the staff to prepare the food,and payment should be done online</p>
                            <div class="details-list">
                                <ul>
                                    <li><i class="fa fa-check"></i>We can order our dish which are uploaded by staffs</li>

                                    <li><i class="fa fa-check"></i>Lunch,Breakfast,Dinner are available</li>
                                    <li><i class="fa fa-check"></i>Payment is done directly to the corresponding staff who prepared the dish </li>
                                    <li><i class="fa fa-check"></i>Registered users can give bulk order for events and parties</li>
								    <li><i class="fa fa-check"></i>Fresh and Homely food</li>
                                    <li><i class="fa fa-check"></i>collect the food at kudumbasree outlets</li>
                    ...
                    <div class="col-md-6 col-sm-6">
                        <img src="img/i2.jpg" alt="" class="img-responsive" align="left">
                    </div>
                </div>
                <div class="col-md-1"></div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 text-center" style="padding:60px;">
                      <h1 class="header-h">Kudumbasree Food Festivals</h1>
                      <p class="header-p">Enjoy the taste of homely prepared food items</p>
                    </div>
                    <div class="col-md-12" style="padding-bottom:60px;">
                        <div class="item active left">
                          <div class="col-md-6 col-sm-6 left-images">
                           <img src="img/puttu.jpg" class="img-responsive">
                         </div>
                         <div class="col-md-6 col-sm-6 details-text">
                          <div class="content-holder">
                            <h2>Traditional food festival</h2>
    ...
    <section id="menu-list" class="section-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center marb-35">
                    <h1 class="header-h">Most Prepared Dishes</h1>
                    <p class="header-p">Menu List of most ordered Kitchen Treasures dishes includes awsome and delicious Food items
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h1 class="header-h">Feedback or Complaints</h1>
                    <p class="header-p">You can send any coplaints regarding the food to us

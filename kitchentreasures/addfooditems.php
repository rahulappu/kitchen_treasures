...
<html lang="en">
  <head>
    <script src="js/fvalidate.js"></script>
                        ...
                        <div class="item active left">
                         ...
                         <div class="col-md-6 col-sm-6 details-text">
                          <div class="content-holder">
							...
							<tr>
							<td>FOOD NAME</td>
							<td><input type="text" name="foodname" id="foodname" onchange="f()" required></td>
							 <div class="validation"></div>
                        </div>
							</tr>
							<tr>
							<td>FOOD RATE</td>
							<td><input type="text" name="foodrate" id="foodrate" onchange="p()" required></td>
							</tr>
              <tr>
              <td>FOOD DESCRIPTION</td>
              <td><input type="text" name="fdescription" id="fdescription" required></td>
              </tr>
              <tr>
              <td>FOOD CATEGORY</td>
              <td>
<select name="category">
  ...
  <option value="Bakery">Bakery</option>
              ...
              <tr>
              <td>FOOD QUANTITY</td>
              <td><input type="text" name="quantity" id="quantity" onchange="q()" required></td>
              </tr>
              <tr>
              <td>FOOD IMAGE</td>
